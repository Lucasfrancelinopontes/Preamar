...
export default function Step7EspeciesCaptura({ nextStep, prevStep }) {
  ...
  const handleVoltar = () => {
    ...
    updateFormData({ especiesCaptura: especies })
    prevStep()
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-8 p-4 max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">
          Captura por Espécie - Etapa 1
        </h2>
        
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
          Informe as espécies capturadas, peso total de cada uma e preço por kg. 
          Na próxima etapa você poderá adicionar dados individuais dos peixes.
        </p>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <label className="flex items-center">
                      <input
                        type="radio"
                        name={`condicao-${index}`}
                        checked={especie.comTripa === false}
